...
describe("Super Admin Journey", () => {
  ...
  it("should show 110 keys and 2 organisation in the filters and the pagination bar", () => {
    ...
    cy.get(`[data-cy="admin-dashboard-filter-Evil Org-label"]`).should(
      "have.text",
      "Evil Org"
    );
    cy.get(`[data-cy="admin-dashboard-filter-Test Org-checkbox"]`).should(
      "not.be.checked"
    );
    cy.get(`[data-cy="admin-dashboard-filter-Test Org-label"]`).should(
      "have.text",
      "Test Org"
    );
  ...
  it("should show only the filtered keys when department filters are set, and clear all filters should reset those filter", () => {
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?selectedDepartments=Test+Org"
    );
    cy.get(`[data-cy="admin-dashboard-filter-Test Org-checkbox"]`).should(
      "be.checked"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage"
    );
    cy.get(`[data-cy="admin-dashboard-filter-Test Org-checkbox"]`).should(
      "not.be.checked"
    );
  ...
  it("should show the correct pagination when going to next pages ", () => {
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=2"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=3"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=4"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=5"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=6"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=7"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=8"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=9"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=10"
    );
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/manage?page=11"
    );
  ...
  it("should be able to revoke any key", () => {
    ...
    cy.url().should(
      "include",
      "http://localhost:8084/find/api/admin/api-keys/revoke/"
    );
    //test cancel button
  ...
  it("Show error page when trying to access Technical support create api key page", () => {
    ...
    cy.url().should(
      "eq",
      "http://localhost:8084/find/api/admin/api-keys/error"
    );
