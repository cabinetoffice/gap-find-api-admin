...
describe('Super Admin Journey', () => {
  ...
  it('creates keys for each department for superAdmin test', () => {
    createKeyForFundingOrganisation1(0, 45);
    createKeyForFundingOrganisation2(45, 110);
  });
  ...
  it('should show the correct pagination when going to next pages ', () => {
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=2');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=3');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=4');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=5');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=6');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=7');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=8');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=9');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=10');
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage?page=11');
  ...
  it('should be able to revoke any key', () => {
    ...
    cy.get(`[data-cy="admin-dashboard-list-table-row-Revoked-Org1Cypress5-link"]`).click();
    cy.url().should('include', 'http://localhost:8084/find/api/admin/api-keys/revoke/');
    //test cancel button
    cy.get(`[data-cy="revoke-cancel-button"]`).click();
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/manage');

    cy.get(`[data-cy="admin-dashboard-list-table-row-Revoked-Org1Cypress9-link"]`).click();
    cy.url().should('include', 'http://localhost:8084/find/api/admin/api-keys/revoke/');
    //test revoke button
    ...
    cy.get(`[data-cy="admin-dashboard-pagination-page-11-link"]`).click();
    cy.get(`[data-cy="admin-dashboard-list-table-row-Revoked-Org1Cypress9-link"]`).should('not.exist');
    cy.get(`[data-cy="admin-dashboard-list-table-row-API-key-Org1Cypress9"]`).should('have.text', `Org1Cypress9`);
    cy.get(`[data-cy="admin-dashboard-list-table-row-Department-Org1Cypress9"]`).should('have.text', 'Test Org');
    cy.get(`[data-cy="admin-dashboard-list-table-row-Created-Org1Cypress9"]`).should('have.text', today);
    cy.get(`[data-cy="admin-dashboard-list-table-row-Revoked-Org1Cypress9-date"]`).should('contain', today);
    cy.get(`[data-cy="admin-dashboard-active-key-count"]`)
      .should('be.visible')
  ...
  it('Show error page when trying to access Technical support create api key page', () => {
    ...
    cy.url().should('eq', 'http://localhost:8084/find/api/admin/api-keys/error');
